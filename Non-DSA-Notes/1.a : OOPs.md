...
**2) Duck Typing :** 
Python is a dynamically typed language. Python cares about behavior, not the object's type.
"If it walks like a duck and quacks like a duck, treat it as a duck." If an object has the required methods, it works.
**Duck typing checks for the required methods at runtime.
If the method doesn't exist, Python raises AttributeError.**
